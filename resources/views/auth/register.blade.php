<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Surname -->
        <div class="mt-4">
            <x-input-label for="nick" :value="__('Surname')" />
            <x-text-input id="surname" class="block mt-1 w-full" type="text" name="surname" :value="old('surname')" required autofocus autocomplete="nick" />
